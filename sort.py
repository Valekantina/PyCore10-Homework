        ...
        if element.is_dir():
            if element.name not in folders:
                ...
                try:
                    ...
                    print(f'Folder {element} is not empty and cannot be deleted')
                    continue
    return None
...
def clean_folder(known_ext, unknown_ext, images, video, documents, audio, archives):
...
if __name__ == '__main__':
    clean_folder(known_ext, unknown_ext, images, images, video, documents, audio, archives)
